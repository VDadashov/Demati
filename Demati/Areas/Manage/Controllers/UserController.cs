using Demati.Areas.Manage.ViewModels.UserVMs;
...
namespace Demati.Areas.Manage.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        {
            IEnumerable<UserVM> users = await _userManager.Users
            ...
            return View(PagenatedList<UserVM>.Create(users, pageIndex, 4));
        }
